...
#SBATCH --gres=gpu:1
#SBATCH --output=lite_test_600_dev1-%j.out
...
python eval.py --model_dir "./output/02_11_22_Oct_11_2024_batch4_margin0.1_lr1e-06lambda0.05/epochs600" --eval_data_path "./data/processed_data/dev_processed1.json" --type_vocab_file "./data/processed_data/types.txt" --batch 1
